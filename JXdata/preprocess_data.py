...
"""
减刑刑期分类数据
来源：/home/chiyao/projects/HANpytorch/generated_data（linux服务器）
/Users/cheryl/Documents/WorkFolder/MyProjects/智慧司法项目/HANpytorch/generated_data（mac本地）
（复制了一份在这个项目中）
/home/chiyao/projects/Chinese-Text-Classification-Pytorch/JXdata/generated_data
/Users/cheryl/Documents/WorkFolder/OthersProjects/ZhiHuiSiFa-fork/Chinese-Text-Classification-Pytorch/JXdata/generated_data

版本：采用20210602/jx_fz_generated.csv数据
...
if __name__ == '__main__':
    # csv_file = 'generated_data/20210602/jx_fz_generated.csv'
    #
    # # 原始数据分析
    ...
    # print(subtype_counts)
    #
    # train_dev_test_split('generated_data/20210602/jx_fz_generated.csv',
    #                      'data')

    df = pd.read_csv('data/train.csv', header=0, keep_default_na=False)
    subtype_counts1 = dict(df['label'].value_counts())
    print(subtype_counts1)

    df = pd.read_csv('data/dev.csv', header=0, keep_default_na=False)
